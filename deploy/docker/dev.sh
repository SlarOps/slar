...
cat docker-compose.yaml | sed "s/ghcr.io\/slarops\//$REGISTRY\//g" | docker compose -f - build
cat docker-compose.yaml | sed "s/ghcr.io\/slarops\//$REGISTRY\//g" | docker compose -f - push
