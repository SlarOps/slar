    ...
    <div className="">
      ...
      {loading ? (
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <button 
                      ...
                      className="px-3 py-1.5 text-xs font-medium text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/30 hover:bg-green-100 dark:hover:bg-green-900/50 border border-green-200 dark:border-green-800 rounded transition-colors"
        ...
        <div className="text-center py-8 text-gray-500 dark:text-gray-400">
          ...
          <p className="mb-2">No services configured for this group yet.</p>
          <p className="text-sm mb-4">Services help organize your monitoring and on-call schedules.</p>
          <button
            onClick={handleCreateService}
